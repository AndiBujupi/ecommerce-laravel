                    ...
                    <div>
                        <form enctype="multipart/form-data" action="{{url('/update_product_confirm',$product->id)}}" method="POST" class="max-w-full p-8">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                ...
                                <input value="{{$product->discountPrice}}"  type="number" name="dis_price" id="small-input" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
